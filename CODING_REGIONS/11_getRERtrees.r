...
#my_alndir<-paste0("/ix1/nclark/ekopania/zoonomia_mammals_241/CODING_REGIONS/coding_region_alignment_filtered-50percent-20bp_translatedAA/AA/")
#my_alndir<-paste0("/ix1/nclark/ekopania/zoonomia_mammals_241/CODING_REGIONS/coding_region_alignment_filtered-50percent-20bp_translatedAA_keepEarlyStops/AA/")
my_alndir<-paste0("/ix1/nclark/ekopania/zoonomia_mammals_241/CODING_REGIONS/coding_region_alignment_filtered-50percent-20bp_translatedAA_keepEarlyStops_replaceAsterisk/AA/")
...
#my_output<-paste0("/ix1/nclark/ekopania/zoonomia_mammals_241/CODING_REGIONS/coding_region_RERtrees_filtered-50percent-20bp_translatedAA.tre")
my_output<-paste0("/ix1/nclark/ekopania/zoonomia_mammals_241/CODING_REGIONS/coding_region_RERtrees_filtered-50percent-20bp_translatedAA.keepEarlyStops_replaceAsterisk.tre")
...
estimatePhangornTreeAll(alndir=my_alndir, pattern="*.fa", treefile=my_intree, output.file=my_output, type="AA", submodel="LG")
Sys.time()
